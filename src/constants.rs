...
// Camera
pub const CAMERA_BASE_SCALE: f32 = 1.2 / PIXEL_SCALE;  // Default zoom level
pub const CAMERA_ZOOM_OUT_SCALE: f32 = 1.35 / PIXEL_SCALE;  // Zoomed out when moving
...
pub const GOBLIN_SIGHT_RANGE: f32 = 100.0;
